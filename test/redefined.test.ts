...
describe('@redefined ts', () => {
  ...
  describe('Field', () => {
    it('doesn\'t set class field', () => {
      registerOverride('firstName', 'Alan');

      const instance = new FieldSet();

      expect(instance.firstName).toBe('Rick');
    });
    ...
    it('class field set in constructor overrides assigned field value', () => {
      registerOverride('firstName', 'Alan');
